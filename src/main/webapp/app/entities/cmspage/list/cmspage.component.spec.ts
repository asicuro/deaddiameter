...
describe('Cmspage Management Component', () => {
  let comp: CmspageComponent;
  let fixture: ComponentFixture<CmspageComponent>;
  let service: CmspageService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cmspage', component: CmspageComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CmspageComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cmspages?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
