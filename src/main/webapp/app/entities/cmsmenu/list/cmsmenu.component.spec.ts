...
describe('Cmsmenu Management Component', () => {
  let comp: CmsmenuComponent;
  let fixture: ComponentFixture<CmsmenuComponent>;
  let service: CmsmenuService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cmsmenu', component: CmsmenuComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CmsmenuComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cmsmenus?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
