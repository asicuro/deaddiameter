...
import it.sincon.deaddiameter.service.MailService;
...
import it.sincon.deaddiameter.web.rest.errors.EmailAlreadyUsedException;
import it.sincon.deaddiameter.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
...
public class UserResource {
    ...
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
        ...
        return ResponseUtil.wrapOrNotFound(userService.getUserWithAuthoritiesByLogin(login).map(userService::cloneUser));
    }
