...
import it.sincon.deaddiameter.repository.LocationRepository;
import it.sincon.deaddiameter.service.LocationService;
...
/**
 * REST controller for managing {@link it.sincon.deaddiameter.domain.Location}.
 */
@RestController
@RequestMapping("/api")
