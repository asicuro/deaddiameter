...
import it.sincon.deaddiameter.domain.Job;
import it.sincon.deaddiameter.repository.JobRepository;
...
/**
 * REST controller for managing {@link it.sincon.deaddiameter.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
